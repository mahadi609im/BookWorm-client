...
const BrowseBooks = () => {
  ...
  const [minRating, setMinRating] = useState(0); // রিকোয়ারমেন্ট অনুযায়ী রেটিং ফিল্টার
  ...
  const filteredBooks = allBooks
    ...
    .sort((a, b) => {
      ...
      if (sortBy === 'shelved')
        return (b.shelvedCount || 0) - (a.shelvedCount || 0); // পপুলারিটি সর্ট
  ...
  return (
    <section className="min-h-screen py-24 px-6 md:px-12 lg:px-20 bg-base-100 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="flex flex-col lg:flex-row gap-6 mb-12 relative z-10">
        ...
        {/* --- Functional Dropdowns (Sort & Rating) --- */}

        <div className="flex flex-wrap gap-4">
          {/* Rating Filter Dropdown (New Functional Addition) */}
                  ...
                  >
                    ...
                    <div className="px-2 flex-1 flex flex-col">
                      ...
                      <div className="flex gap-3 mt-auto">
                        {/* Add to Shelf Button - Redirect to details to add */}
